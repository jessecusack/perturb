...
arguments (Input)
    iProfile uint32 {mustBePositive} % Profile number
    row (1,:) table % pInfo for this profile
    profile(1,:) table % profile at a depth
end % arguments Input
...
title([ ...
    ...
    profile.depth, ...
    num2str(profile.FM, 2), ...
    num2str(profile.method), ...
